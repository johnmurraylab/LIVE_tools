...
## Installation
efore running the examples below, please ensure the package and its dependencies are installed.
...
```{r}
cran_deps <- c(
  "data.table", "dplyr", "ggtree", "plotly", "reticulate", "ggplot2", "tidyr", "viridis" 
...
```
### Install LIVEtools
Download LIVEtools release package from github:

Place it in your R working directory, and run the following command
```{r}
